...
func NewRepo(a *cfg.AppConfig, db *driver.Db) *Repository {
	return &Repository{
		App: a,
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	rcf := "2006-01-02"
	sd, err := time.Parse(rcf, r.Form.Get("start_date"))
	ed, err := time.Parse(rcf, r.Form.Get("end_date"))
